  ...
  return (
    ...
    onClick={handleClick}>
        ...
        <div className="flex flex-row items-center mb-[18px]">
          ...
          text-[#808191]">Campaign category</p>
        </div>
        <div className='block'>
            <h3 className='font-epilogue font-semibold text-[16px] 
            text-white text-left'>{title}</h3>
            <p className='mt-[5px] font-epilogue font-normal font-[12px] 
            leating-[18px] text-[#808191] truncate'>{description}</p>
        </div>
        ...
        <div className='flex items-center mt-[20px] gap-[12px]'>
            <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#13131a]">
                <img src={thirdweb} alt="owner" className='w-1/2 h-1/2 object-contain'/>
            </div>
